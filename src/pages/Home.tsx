...
const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="flex-1 space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-orange-100 text-lg">
                {highestRatedProduct
                  ? `${highestRatedProduct.name} - ${formatPrice(
                      highestRatedProduct.price
                    )}`
          ...
          <div className="hidden lg:block">
            {highestRatedProduct ? (
              ...
              >
                <img
                  src={
                    highestRatedProduct.display_image ||
                    (highestRatedProduct.images &&
                    highestRatedProduct.images.length > 0
                      ? highestRatedProduct.images[0].image_url
                      : "https://images.pexels.com/photos/788946/pexels-photo-788946.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2")
                  }
                  alt="Featured Product"
                  className="w-64 h-64 object-cover rounded-2xl shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-300 group-hover:scale-105"
                />
                <div className="absolute -top-4 -right-4 bg-white text-orange-500 px-4 py-2 rounded-full font-bold shadow-lg">
                  {`${parseFloat(highestRatedProduct.average_rating).toFixed(
                    1
                  )}★`}
                </div>
              </Link>
      ...
      <section className="grid grid-cols-5 gap-6">
        {loading
          ...
          : categories.map((category: any, index: number) => (
              ...
              >
                <div
                  className={`w-16 h-16 mx-auto rounded-2xl ${getCategoryColor(
                    index
      ...
      <section
        className={`rounded-2xl p-8 ${isDark ? "bg-gray-800" : "bg-white"}`}
      >
